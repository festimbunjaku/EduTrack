...
import { ArrowLeft, Eye, Loader2, Mail, Shield, User, UserPlus } from 'lucide-react';
...
export default function Create({ roles }: PageProps<CreateUserProps>) {
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="flex h-full flex-1 flex-col gap-6 p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">Create New User</h1>
            ...
            <form onSubmit={handleSubmit}>
              <CardHeader className="pb-6 border-b">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-xl">New User Account</CardTitle>
                    <CardDescription className="text-sm text-muted-foreground">
                      Enter account details for the new user
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
                ...
                <div className="pt-3 pb-2">
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-card px-2 text-muted-foreground">Account Security</span>
                    </div>
                  </div>
                </div>
              ...
              <CardFooter className="flex justify-end border-t px-6 py-4 bg-muted/20">
                <div className="flex gap-3">
                  ...
                  <Button 
                    type="submit" 
                    disabled={processing}
                    className="bg-green-500 hover:bg-green-600 transition-colors shadow-md"
                  >
                    {processing ? (
                      <>
